    ...
    useEffect(() => {
        const getNote = async () => {
            try {
                ...
                if (id && token) {
                    const res = await axios.get(`https://notes-backend-5zui.onrender.com/api/notes/${id}`, {
    ...
    const editNote = async e => {
        ...
        try {
            ...
            if (token) {
                ...
                await axios.put(`https://notes-backend-5zui.onrender.com/api/notes/${id}`, newNote, {
                    headers: { Authorization: token }
                });
